...
#Estamos notando que la cantidad de embarazosos en las personas del laboratorio llevan un descenso
#significativo, y es como notamos que la mayor parte de 
#personas han estado embarazadas solo una vez, y que hay claramente eventos atipicos superando los 13 #embarazos. 
```{r}
...
#Notamos que el indice de masa corporal se eleva entre 25 y 40kg, lo cual nos muestra que en la mayoria
#de personas existe obesidad, como tambien una cantidad notoria de mejor salud en el indice de MC 20 a #25kg y un muy mal indice de 40 a 45kg. Asi mismo notamos vamos atipicos menores a 5kg y mayores a 65kg.
